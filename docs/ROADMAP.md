...
| S2 | Phone attests its own proximity | Crit | ◐ P1.4 — an enrolled host must vouch for every envelope, and host-measured RSSI overrides the phone's claim when present; radio sampling: P1.5 |
