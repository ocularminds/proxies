...
| P3.pilot ⬜ | Pilot activation for the chosen vertical: hardware selection (drives P2.7 gateway radio), site provisioning, calibration, 30-day run (M4) — **blocked on the vertical decision** |
