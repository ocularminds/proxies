...
| P3.W2 ⬜ | Waste field deployment: per-bin firmware (envelope per TELEMETRY.md — this replaces the shared-gateway framing of P2.7 for this vertical), hardware procurement, install, 30-day run → M4 |
